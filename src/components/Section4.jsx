...
const Section4 = () => {
    return (
        <section
            className="flex flex-col items-center  w-full  mx-auto  justify-center relative  py-0 md:py-16 space-y-0 h-screen"
        >
            <div className='w-[90%] md:w-4/5  flex pt-4 md:pt-14 pb-2 md:pb-8 flex-col items-center  mx-auto space-y-5 md:space-y-12  justify-around gap-4'>
                <AnimatedText text={"How are we Different?"} />
                <div className='object-contain w-full h-40 md:h-80 items-center flex justify-center'>
