        ...
        >
            <div className='md:w-4/5 w-[90%]  flex flex-col items-center mx-auto space-y-8  justify-around py-4 md:py-16'>
                ...
                <div className='flex flex-col'>
                    <AnimatedWhiteText className={'text-xl md:text-3xl lg:text-4xl font-semibold text-white text-center'} text={"Decade-Long Timelines."} />
                    <AnimatedWhiteText className={'text-xl md:text-3xl lg:text-4xl font-semibold text-white text-center'} text={"Millions in Development Costs."} />
                    <AnimatedWhiteText className={'text-xl md:text-3xl lg:text-4xl font-semibold text-white text-center'} text={"Just. One. Trait."} />
...
"/>
                ...
                <div className='flex flex-col space-y-9 items-center w-full justify-center'>
                    ...
                    <AnimatedWhiteText text={"We think it's time Agriculture catches up."} className={'text-sm md:text-4xl  lg:text-5xl   text-white font-semibold md:font-bold text-center'} />
                </div>
            </div>
        </section>
    )
