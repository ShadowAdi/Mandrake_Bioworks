  ...
  return (
    <div className='flex flex-col items-center justify-center gap-y-3 md:gap-y-4'>
      ...
      <div className='flex items-center justify-center flex-col space-y-0 md:space-y-1'>
        <span className='text-subheading-sm sm:text-subheading-sm md:text-subheading-sm lg:text-subheading xl:text-subheading-lg 2xl:text-subheading-xl 3xl:text-subheading-3xl 2xl:text-subheading-2xl  font-semibold text-white text-center'>
          {name}
        </span>
