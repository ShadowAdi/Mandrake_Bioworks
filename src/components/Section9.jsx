        ...
        >
            <div className='w-[90%] md:w-4/5 flex pb-2 flex-col items-center gap-20 mx-auto space-y-1 md:space-y-12 justify-center  md:justify-around'>
                ...
                <div className='flex flex-col space-y-2 md:space-y-7 items-center w-[90%] md:w-[70%] justify-center'>
                    ...
                    <AnimatedWhiteText text={"Building the Plant Design Factory of the Future"} className={"lg:text-4xl md:text-3xl text-2xl xl:text-5xl  uppercase text-white font-bold text-center"} />

                    <AnimatedWhiteText className={"text-white text-sm md:text-xl text-center"} text={"Whether you're interested in joining our team, partnering with us, or simply curious to learn more about our work—let's connect."} />
