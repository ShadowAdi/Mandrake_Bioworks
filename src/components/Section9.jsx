    ...
    return (
        ...
        >
            <div className="w-[90%]  flex flex-col items-center mx-auto gap-8 md:gap-12 lg:gap-16">
                ...
                <div className="flex flex-col items-center text-center w-[90%] px-2  lg:px-16 gap-4 md:gap-6 lg:gap-8  ">
                    <AnimatedWhiteText
                        text="Building the Plant Design Factory of the Future"
                        className="text-lg md:text:xl lg:text-2xl xl:text-3xl 2xl:text-6xl uppercase font-bold text-white "
                    />
                    <AnimatedWhiteText
